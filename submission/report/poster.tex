...
\begin{figure}
\begin{center}
\includegraphics[width=600px]{figs/dr_devf1.png}
\caption{The scores reported in the papers we looked at are obtained by working on the same data as us, but with fewer labels (5 instead of 17). Although we chose to stick to the 17 labels version for our whole analysis, because we consider it to be more interesting (because more complex), we however tried to reach state-of-the-art performance on the "reduced" labels. }
\label{dr_devf1}
\end{center}
\end{figure}
